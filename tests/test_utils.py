from entryWidget.utils import colorList, rgb_to_hex, hex_to_rgb, findColor
...
def test_findColor():
    ...
    # check all colors in colorList
    for c in colorList:
        # adjust rgb values slightly to test the search algorithm (which gets closest by rgb distance)
