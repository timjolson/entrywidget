...
print("\n----------------------- isError Callback")
widgetDefault = AutoColorLineEdit(isError=detect_error)
widgetDefault.setText("Try typing 'error'")
widgetDefault.show()
app.exec_()

print("\n----------------------- liveErrorChecking=False & isError Callback")
widgetDefault = AutoColorLineEdit(isError=detect_error, liveErrorChecking=False)
widgetDefault.setText("Try typing 'error', then press ENTER")
widgetDefault.show()
app.exec_()
